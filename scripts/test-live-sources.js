const { scrapeCatalog, scrapeMeta, scrapeStreams } = require("../src/scrapers/avmirror");
const { scrape18JavCatalog, scrape18JavMeta, scrape18JavStreams } = require("../src/scrapers/18jav");
...
(async () => {
  ...
  try {
    ...
    // Os scrapers atuais usam HTTP direto e não mantêm browsers abertos.
  }
